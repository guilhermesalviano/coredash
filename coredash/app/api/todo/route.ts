...
export async function GET(req: NextRequest) {
  ...
  if (cached) {
    ...
    return formatResponse(req, { message: "Todos data retrieved from cache", data: filteredCached });
  }
  ...
  try {
    ...
    return formatResponse(req, { message: "Todos data retrieved successfully", data: responseData });
  } catch (error: unknown) {
    console.error(error)
